...
class EtatBesoinBudgetPage extends StatefulWidget {
  const EtatBesoinBudgetPage({Key? key}) : super(key: key);

  @override
  State<EtatBesoinBudgetPage> createState() => _EtatBesoinBudgetPageState();
}

class _EtatBesoinBudgetPageState extends State<EtatBesoinBudgetPage> {
