...
class DetailAmortissement extends StatefulWidget {
  const DetailAmortissement({Key? key, required this.id}) : super(key: key);
  final int id;

  @override
  State<DetailAmortissement> createState() => _DetailAmortissementState();
}
...
class _DetailAmortissementState extends State<DetailAmortissement> {
            ...
            children: [
              ...
              Expanded(
                ...
                child: Padding(
                    ...
                    child: FutureBuilder<AmortissementModel>(
                        future: AmortissementApi().getOneData(widget.id),
                        builder: (BuildContext context,
                            AsyncSnapshot<AmortissementModel> snapshot) {
                          if (snapshot.hasData) {
                            AmortissementModel? data = snapshot.data;
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Row(
  ...
  Widget pageDetail(AmortissementModel data) {
  ...
  Widget dataWidget(AmortissementModel data) {
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: SelectableText(data.titleArmotissement,
  ...
  Widget infosEditeurWidget(AmortissementModel data) {
    final bodyMedium = Theme.of(context).textTheme.bodyMedium;
  ...
  Future<void> submitUpdateDG(AmortissementModel data) async {
    final amortissementModel = AmortissementModel(
        titleArmotissement: data.titleArmotissement,
  ...
  Future<void> submitUpdateFIN(AmortissementModel data) async {
    final amortissementModel = AmortissementModel(
        titleArmotissement: data.titleArmotissement,
        comptes: data.comptes,
        intitule: data.intitule,
  ...
  Future<void> submitUpdateBudget(AmortissementModel data) async {
    final amortissementModel = AmortissementModel(
        titleArmotissement: data.titleArmotissement,
        comptes: data.comptes,
        intitule: data.intitule,
  ...
  Future<void> submitUpdateDD(AmortissementModel data) async {
    final amortissementModel = AmortissementModel(
        titleArmotissement: data.titleArmotissement,
        comptes: data.comptes,
        intitule: data.intitule,
