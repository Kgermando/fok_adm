...
class JournalDD extends StatefulWidget {
  const JournalDD({Key? key}) : super(key: key);

  @override
  State<JournalDD> createState() => _JournalDDState();
}

class _JournalDDState extends State<JournalDD> {
