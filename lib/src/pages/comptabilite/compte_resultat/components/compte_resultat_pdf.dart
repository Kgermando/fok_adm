...
class CompteResultatPdf {
   static Future<void> generate(CompteResulatsModel data,
    ...
    pdf.addPage(MultiPage(
      build: (context) => [
        ...
        buildTitle(data),
        Divider(),
        buildBody(data, totalCharges1, totalCharges123, totalGeneralCharges, totalProduits1, totalProduits123, totalGeneralProduits)
      ],
  ...
  static Widget buildCompanyAddress(UserModel user) => Column(
        ...
        children: [
          pw.SizedBox(
            width: 200,
            child: Text(
                "located within the company's building. location. Address: Keas 69 Str. 15234, Chalandri",
  ...
  static Widget buildBody(CompteResulatsModel data, 
      double totalCharges1,
      double totalCharges123, 
      double totalGeneralCharges,
      double totalProduits1,
          ...
          Expanded(
            child: Column(
              children: [
                ...
                Divider(color: PdfColors.amber),
                SizedBox(height: p30),
                chargeWidget(data, totalCharges1, totalCharges123, totalGeneralCharges)
              ],
            ),
          ),
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Divider(color: PdfColors.amber),
                  SizedBox(height: p30),
                  produitWidget(data, totalProduits1, totalProduits123, totalGeneralProduits)
                ],
              ),
            ),
          ),
  ...
  static Widget chargeWidget(CompteResulatsModel data, 
    double totalCharges1,
    double totalCharges123,
    double totalGeneralCharges
    ) {
      ...
      children: [
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Achats Marchandises",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Achats Approvionnements",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Variation Approvionnements",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Autres Charges Externe",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Renumeration du Personnel",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Dotatiopns Provisions",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Charges financieres",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Charges exptionnelles (II)",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
      ...
      children: [
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Ventes Marchandises",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Production Immobilisée",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Subvention d'exploitations",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Produit financieres",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Produit exceptionnels (II)",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
        ...
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text("Solde debiteur (pertes) :",
                  textAlign: TextAlign.left),
            ),
            Expanded(
              flex: 1,
