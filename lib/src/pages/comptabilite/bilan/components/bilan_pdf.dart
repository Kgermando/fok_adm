...
class BilanPdf {
  static Future<void> generate(BilanModel data, 
    List<CompteActifModel> compteActifList, 
    List<ComptePassifModel> comptePassifList) async {
  ...
  static Widget compteActifWidget(List<CompteActifModel> compteActifList) { 
 ...
 static Widget comptePassifWidget(List<ComptePassifModel> comptePassifList) { 
