...
class _DetailEtatMaterielState extends State<DetailEtatMateriel> {
  ...
  Widget infosEditeurWidget(EtatMaterielModel data) {
  ...
  Future<void> submitUpdateFIN(EtatMaterielModel data) async {
    final etatMaterielModel = EtatMaterielModel(
        nom: data.nom,
        modele: data.modele,
        marque: data.marque,
  ...
  Future<void> submitUpdateBudget(EtatMaterielModel data) async {
    final etatMaterielModel = EtatMaterielModel(
        nom: data.nom,
        modele: data.modele,
        marque: data.marque,
  ...
  Future<void> submitUpdateDD(EtatMaterielModel data) async {
    final etatMaterielModel = EtatMaterielModel(
        nom: data.nom,
        modele: data.modele,
        marque: data.marque,
