...
class _DetailMobilierState extends State<DetailMobilier> {
  ...
  Future<void> getData() async {
    ...
    MobilierModel data = await MobilierApi().getOneData(widget.id!);
    setState(() {
      user = userModel;
      nom = data.nom;
      modele = data.modele;
  ...
  Widget infosEditeurWidget(MobilierModel data) {
  ...
  Future<void> submitUpdateDG(MobilierModel data) async {
  ...
  Future<void> submitUpdateFIN(MobilierModel data) async {
    final mobilierModel = MobilierModel(
        nom: data.nom,
        modele: data.modele,
        marque: data.marque,
  ...
  Future<void> submitUpdateBudget(MobilierModel data) async {
    final mobilierModel = MobilierModel(
        nom: data.nom,
        modele: data.modele,
        marque: data.marque,
  ...
  Future<void> submitUpdateDD(MobilierModel data) async {
    final mobilierModel = MobilierModel(
        nom: data.nom,
        modele: data.modele,
        marque: data.marque,
