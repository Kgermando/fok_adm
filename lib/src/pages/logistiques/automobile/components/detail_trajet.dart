...
class _DetailTrajetState extends State<DetailTrajet> {
  ...
  Widget infosEditeurWidget(TrajetModel data) {
  ...
  Future<void> submitUpdateDG(TrajetModel data) async {
  ...
  Future<void> submitUpdateFIN(TrajetModel data) async {
    final trajetModel = TrajetModel(
        nomeroEntreprise: data.nomeroEntreprise,
        nomUtilisateur: data.nomUtilisateur,
        trajetDe: data.trajetDe,
  ...
  Future<void> submitUpdateBudget(TrajetModel data) async {
    final trajetModel = TrajetModel(
        nomeroEntreprise: data.nomeroEntreprise,
        nomUtilisateur: data.nomUtilisateur,
        trajetDe: data.trajetDe,
  ...
  Future<void> submitUpdateDD(TrajetModel data) async {
    final trajetModel = TrajetModel(
        nomeroEntreprise: data.nomeroEntreprise,
        nomUtilisateur: data.nomUtilisateur,
        trajetDe: data.trajetDe,
