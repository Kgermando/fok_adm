...
class _DetailFinExterieurState extends State<DetailFinExterieur> {
                ...
                child: Padding(
                    ...
                    child: FutureBuilder<FinanceExterieurModel>(
                        ...
                        builder: (BuildContext context,
                          ...
                          if (snapshot.hasData) {
                            FinanceExterieurModel? financeExterieurModel =
                                snapshot.data;
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
  ...
  Widget infosEditeurWidget(FinanceExterieurModel data) {
    final bodyMedium = Theme.of(context).textTheme.bodyMedium;
  ...
  Future<void> submitUpdateDG(FinanceExterieurModel data) async {
    final financeExterieurModel = FinanceExterieurModel(
        ...
        ressourceFin: data.ressourceFin,
    ...
    await FinExterieurApi().updateData(data.id!, financeExterieurModel);
    Routemaster.of(context).pop();
  ...
  Future<void> submitUpdateFIN(FinanceExterieurModel data) async {
    final financeExterieurModel = FinanceExterieurModel(
        nomComplet: data.nomComplet,
        pieceJustificative: data.pieceJustificative,
        libelle: data.libelle,
  ...
  Future<void> submitUpdateBudget(FinanceExterieurModel data) async {
    final financeExterieurModel = FinanceExterieurModel(
        nomComplet: data.nomComplet,
        pieceJustificative: data.pieceJustificative,
        libelle: data.libelle,
  ...
  Future<void> submitUpdateDD(FinanceExterieurModel data) async {
    final financeExterieurModel = FinanceExterieurModel(
        nomComplet: data.nomComplet,
        pieceJustificative: data.pieceJustificative,
        libelle: data.libelle,
