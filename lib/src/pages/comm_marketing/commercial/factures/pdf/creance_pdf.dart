...
class CreancePDF {
  ...
  static Widget buildHeader(CreanceCartModel creanceCartModel, UserModel user) =>
      Column(
  ...
  static Widget buildCustomerAddress(UserModel user) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(user.succursale.toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold)),
          Text("Adresse ..."),
        ],
      );

  static Widget buildInvoiceInfo(CreanceCartModel creanceCartModel, UserModel user) {
    final titles = <String>[
      'RCCM:',
      'N° Impôt:',
      'ID Nat.:',
