...
class RestitutionStock extends StatefulWidget {
  ...
  @override
  _RestitutionStockState createState() => _RestitutionStockState();
}
...
class _RestitutionStockState extends State<RestitutionStock> {
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(
                            flex: 1,
                            child: Text("Produit :", style: headline6)),
                        Expanded(
                            flex: 3,
                            child:
                                Text(widget.achat.idProduct, style: headline6)),
                      ],
                    ),
                    const SizedBox(
                      height: p20,
  ...
  Future<void> transfertProduit() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text("${achatModel.idProduct} transferé!"),
