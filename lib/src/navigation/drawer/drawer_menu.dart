        ...
        child: ListView(
          ...
          children: [
            ...
            if (user.departement == 'Ressources Humaines' ||
              ...
              if (pageCurrente != null) RhNav(pageCurrente: pageCurrente),

            if (user.departement == 'Budgets' ||
                user.departement == 'Administration')
              if (pageCurrente != null) BudgetNav(pageCurrente: pageCurrente),

            if (user.departement == 'Finances' ||
                user.departement == 'Administration')
              if (pageCurrente != null) FinancesNav(pageCurrente: pageCurrente),
