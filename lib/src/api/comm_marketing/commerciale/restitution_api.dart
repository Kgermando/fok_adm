...
class RestitutionApi {
  ...
  Future<RestitutionModel> updateData(int id, RestitutionModel restitutionModel) async {
    final accessToken = await storage.read(key: 'accessToken');

    var data = restitutionModel.toJson();
    var body = jsonEncode(data);
    var updateUrl =
        Uri.parse("$mainUrl/restitutions/update-restitution/$id");
  ...
  Future<RestitutionModel> deleteData(int id) async {
    ...
    var deleteUrl =
        Uri.parse("$mainUrl/restitutions/delete-restitution/$id");
