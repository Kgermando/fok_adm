...
class FactureApi {
  ...
  Future<FactureCartModel> updateData(int id, FactureCartModel factureCartModel) async {
    final accessToken = await storage.read(key: 'accessToken');

    var data = factureCartModel.toJson();
    var body = jsonEncode(data);
    var updateUrl =
        Uri.parse("$mainUrl/factures/update-facture/$id");
  ...
  Future<FactureCartModel> deleteData(int id) async {
    ...
    var deleteUrl =
        Uri.parse("$mainUrl/factures/delete-facture/$id");
