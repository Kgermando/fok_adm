...
class LivraisonHistoryApi {
  ...
  Future<LivraisonHistoryModel> insertData(LivraisonHistoryModel livraisonHistoryModel) async {
  ...
  Future<LivraisonHistoryModel> updateData(int id, LivraisonHistoryModel livraisonHistoryModel) async {
    final accessToken = await storage.read(key: 'accessToken');
