...
class PerformenceNoteApi {
  ...
  Future<PerformenceNoteModel> updateData(int id, PerformenceNoteModel performenceModel) async {
    final accessToken = await storage.read(key: 'accessToken');

    var data = performenceModel.toJson();
    var body = jsonEncode(data);
    var updateUrl = Uri.parse("$mainUrl/rh/performences-note/update-performence-note/$id");
  ...
  Future<PerformenceNoteModel> deleteData(int id) async {
    ...
    var deleteUrl = Uri.parse("$mainUrl/rh/performences-note/delete-performence-note/$id");
