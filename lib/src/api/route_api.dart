...
var addPresenceEntrerUrl =
    Uri.parse("$mainUrl/rh/presences-entrers/insert-new-presence-entrer");
var listPresenceSortieUrl = Uri.parse("$mainUrl/rh/presences-sorties/");
var addPresenceSortieUrl =
    Uri.parse("$mainUrl/rh/presences-sorties/insert-new-presence-sortie");
...
var addCompteActifUrl =
    Uri.parse("$mainUrl/comptabilite/comptes-actif/insert-new-compte-actif");
var comptePassifUrl = Uri.parse("$mainUrl/comptabilite/comptes-passif/");
var addComptePassifUrl =
    Uri.parse("$mainUrl/comptabilite/comptes-passif/insert-new-compte-passif");
